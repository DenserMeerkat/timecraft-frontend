...
const sheetVariants = cva(
  "fixed z-50 gap-4 bg-white p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duhoursDistributionn-300 data-[state=open]:duhoursDistributionn-500 dark:bg-zinc-950",
  {
    variants: {
      side: {
